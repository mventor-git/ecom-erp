...
const SAMPLE_PRODUCTS = [
  ...
  { name: 'Canvas Sneakers', description: 'Classic canvas sneakers with rubber sole. Ideal for everyday wear.', price: 8999, category: 'clothing', stock: 20, image_url: '', colors: [{ name: 'Black/White', hex: '#2d2d2d' }, { name: 'Navy/Orange', hex: '#1e3a5f' }] },
  ...
  { name: 'Ultrasonic Oil Diffuser', description: 'Ultrasonic cool mist diffuser with 7-color LED mood lighting. Runs up to 10 hours, auto shut-off, and covers rooms up to 300 sq ft.', price: 3299, category: 'home-garden', stock: 18, image_url: '', colors: [{ name: 'White', hex: '#f8f8f8' }, { name: 'Wood', hex: '#92400e' }] },
