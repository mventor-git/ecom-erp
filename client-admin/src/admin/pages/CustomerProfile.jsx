        ...
        <div className="flex flex-col md:flex-row md:items-start gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-3 mt-3 text-sm text-stone-600 dark:text-[#a8a29e]">
              ...
              <span className="inline-flex items-center gap-1.5"><Calendar size={14}/> {new Date(profile.created_at || Date.now()).toLocaleDateString(dateLocale())}</span>
            </div>
          </div>
                ...
                {profile.orders.map(o => (
                  <li key={o.id} className="py-3 flex justify-between">
                    <div>
                      ...
                      <span className="ms-3 text-xs text-stone-400 dark:text-[#6b6560]">{new Date(o.created_at).toLocaleDateString(dateLocale())}</span>
                    </div>
