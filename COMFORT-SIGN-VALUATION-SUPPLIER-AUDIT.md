# Comfort Sign — Inventory Costing · Retail Pricing · Supplier Audit
...
- `ADMIN_PASSWORD` remains a weak default (`admin123`) in `.env` → **SECURITY BLOCKER**: must be rotated/forced before deployment (documented, not changed — see security note).
