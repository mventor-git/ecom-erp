...
- **091 CLOSED· 092· 094· 095 DELIVERED. IN FLIGHT: 093 (inventory↔GL integrity: opening-balance/shrinkage/gain + goods-return journaling + ledger-vs-inventory reconciliation control), then 096 (end-to-end business-journey acceptance + operator docs + final readiness).** Stop condition = usable-product acceptance (mission brief A–O), not ticket count.
