# Ecom-ERP — Payment & Order Domain Findings (checkpoint)
...
9. **Invoices/receipts?** Documents are generated server-side from order data; see `ECOM-ERP-ORDER-DOCUMENTS` (to be
