# Pricing Reality — Ecom-ERP (Audit Only)

PRICE STORAGE: products.price (retail, integer cents) + cost_price (wholesale current). price_lists (retail/offer ACTIVE; wholesale/semi_wholesale LEGACY-inactive since 065) with discount_percent. product_prices (override per product per list).
