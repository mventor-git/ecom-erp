    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      {orders.length === 0 ? (
        <div className="glass-card p-12 text-center">
          <svg className="w-14 h-14 mx-auto text-gray-300 dark:text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              return (
                <div key={status} className="flex items-center shrink-0">
                  <div className="flex flex-col items-center w-16 sm:w-20">
                    ...
                    <span className={`mt-1.5 text-[11px] sm:text-xs text-center leading-tight ${
