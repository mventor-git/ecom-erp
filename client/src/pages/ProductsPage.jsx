          ...
          <p className="mt-1 text-gray-500 dark:text-gray-400">
            ...
            {hasActiveFilters && (
              <button
                ...
                className="ms-2 text-xs text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium"
              >
                {t('Clear filters')}
              </button>
            )}
      ...
      <div className="glass-card p-4 mb-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-full ps-10 pe-10 py-2.5 bg-transparent border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition duration-200 text-sm text-gray-900 dark:text-white placeholder:text-gray-400"
          />
          {search && (
            <button
              onClick={() => setSearch('')}
